...
{
	sunxi_simple_gates_setup(node, NULL, 0, false);
}

static void __init sunxi_simple_gates_init_h3(struct device_node *node)
{
	sunxi_simple_gates_setup(node, NULL, 0, true);
}
...
CLK_OF_DECLARE(sun8i_a23_apb2, "allwinner,sun8i-a23-apb2-gates-clk",
	       sunxi_simple_gates_init);
CLK_OF_DECLARE(sun8i_h3_bus, "allwinner,sun8i-h3-bus-gates-clk",
	       sunxi_simple_gates_init_h3);
