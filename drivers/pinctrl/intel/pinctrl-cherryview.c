...
static const struct pinctrl_pin_desc southwest_pins[] = {
	...
	PINCTRL_PIN(22, "UART2_CTS_B"), /* 15 */

	PINCTRL_PIN(30, "MF_HDA_CLK"), /* 16 */
	...
	PINCTRL_PIN(37, "MF_HDA_DOCKENB"), /* 23 */

	PINCTRL_PIN(45, "I2C5_SDA"), /* 24 */
	...
	PINCTRL_PIN(52, "I2C_NFC_SCL"), /* 31 */

	PINCTRL_PIN(60, "I2C1_SDA"), /* 32 */
	...
	PINCTRL_PIN(67, "I2C3_SCL"), /* 39 */

	PINCTRL_PIN(75, "SATA_GP0"), /* 40 */
...
static const struct pinctrl_pin_desc north_pins[] = {
	...
	PINCTRL_PIN(8, "GPIO_DFX_6"), /* 8 */

	PINCTRL_PIN(15, "GPIO_SUS0"), /* 9 */
	...
	PINCTRL_PIN(27, "SEC_GPIO_SUS9"), /* 21 */

	PINCTRL_PIN(30, "TRST_B"), /* 22 */
	PINCTRL_PIN(31, "TCK"),
	...
	PINCTRL_PIN(41, "TDI"), /* 33 */

	PINCTRL_PIN(45, "GP_CAMERASB_05"), /* 34 */
	...
	PINCTRL_PIN(56, "GP_CAMERASB_04"), /* 45 */

	PINCTRL_PIN(60, "PANEL0_BKLTEN"), /* 46 */
	...
	PINCTRL_PIN(66, "HV_DDI0_DDC_SDA"), /* 52 */
	...
	PINCTRL_PIN(72, "PANEL0_VDDEN"), /* 58 */
};
...
static const struct pinctrl_pin_desc southeast_pins[] = {
	...
	PINCTRL_PIN(15, "SDMMC2_D3_CD_B"), /* 8 */
	...
	PINCTRL_PIN(26, "SDMMC1_D3_CD_B"), /* 19 */

	PINCTRL_PIN(30, "SDMMC3_D1"), /* 20 */
	PINCTRL_PIN(31, "SDMMC3_CLK"),
	PINCTRL_PIN(32, "SDMMC3_D3"),
	PINCTRL_PIN(33, "SDMMC3_D2"),
	PINCTRL_PIN(34, "SDMMC3_CMD"),
	PINCTRL_PIN(35, "SDMMC3_D0"), /* 25 */

	PINCTRL_PIN(45, "MF_LPC_AD2"), /* 26 */
	...
	PINCTRL_PIN(52, "MF_LPC_AD1"), /* 33 */

	PINCTRL_PIN(60, "SPI1_MISO"), /* 34 */
	...
	PINCTRL_PIN(69, "MMC1_RCLK"), /* 43 */

	PINCTRL_PIN(75, "USB_OC1_B"), /* 44 */
